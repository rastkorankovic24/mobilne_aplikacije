...
public class MainActivity extends AppCompatActivity implements SensorEventListener {
    ...
    private static final String PREFS_NAME = "Kolokvijum2DPrefs";
    private static final String PREFS_KEY_TEKST = "tekst";
    private static final String CHANNEL_ID = "posts_channel";
    private static final String FILE_PROVIDER_AUTHORITY = "com.example.kolokvijum2d.fileprovider";
    private static final int POSTS_TO_SAVE = 5;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        postService = RetrofitClient.getPostService();
    ...
    private void setupListeners() {
        ...
        imageViewPhoto.setOnLongClickListener(v -> {
            String body = dbHelper.getFirstPostBody();
            if (body != null) {
                Toast.makeText(this, body, Toast.LENGTH_LONG).show();
            } else {
                Toast.makeText(this, R.string.no_post_body, Toast.LENGTH_SHORT).show();
            }
            return true;
        });
        ...
        buttonAction.setOnClickListener(v -> deleteFirstPostAndNotify());
    }
    ...
    private void handleSwitchOn() {
        ...
        if (dbHelper.getPostCount() == 0) {
            Toast.makeText(this, R.string.posts_loading, Toast.LENGTH_SHORT).show();
            fetchAndSavePosts();
        } else {
            String title = dbHelper.getFirstPostTitle();
            if (title != null) {
        ...
        postService.getPosts().enqueue(new Callback<List<Post>>() {
            ...
            public void onResponse(@NonNull Call<List<Post>> call, @NonNull Response<List<Post>> response) {
                if (response.isSuccessful() && response.body() != null && !response.body().isEmpty()) {
                    ...
                    int count = Math.min(posts.size(), POSTS_TO_SAVE);
                    dbHelper.insertPosts(posts.subList(0, count));

                    Toast.makeText(MainActivity.this, getString(R.string.posts_loaded, count), Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(MainActivity.this, R.string.posts_fetch_error, Toast.LENGTH_LONG).show();
                }
            }
            ...
            public void onFailure(@NonNull Call<List<Post>> call, @NonNull Throwable t) {
                Toast.makeText(MainActivity.this,
                        getString(R.string.posts_fetch_error_detail, t.getMessage()),
                        Toast.LENGTH_LONG).show();
            }
        });
    }
    ...
    private void deleteFirstPostAndNotify() {
        if (dbHelper.getPostCount() == 0) {
            sendNoPostsNotification();
            Toast.makeText(this, R.string.no_posts_notification, Toast.LENGTH_LONG).show();
            return;
        }
    ...
    private void createNotificationChannel() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            NotificationChannel channel = new NotificationChannel(
                    CHANNEL_ID,
                    getString(R.string.channel_posts),
    ...
    private void sendNoPostsNotification() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.TIRAMISU) {
            if (ContextCompat.checkSelfPermission(this, Manifest.permission.POST_NOTIFICATIONS)
                    != PackageManager.PERMISSION_GRANTED) {
                return;
        ...
        NotificationCompat.Builder builder = new NotificationCompat.Builder(this, CHANNEL_ID)
                ...
                .setContentText(getString(R.string.no_posts_notification))
    ...
    protected void onResume() {
        ...
        if (switchPosts.isChecked() && hasLocationPermission()) {
            loadLocation();
        }
    }
