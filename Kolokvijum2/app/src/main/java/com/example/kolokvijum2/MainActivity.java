...
public class MainActivity extends AppCompatActivity implements SensorEventListener {
    ...
    private static final String PREFS_NAME = "Kolokvijum2Prefs";
    private static final String PREFS_KEY_TEKST = "tekst";
    private static final String CHANNEL_ID = "posts_channel";
    private static final String FILE_PROVIDER_AUTHORITY = "com.example.kolokvijum2.fileprovider";
        ...
        postService.getPosts().enqueue(new Callback<List<Post>>() {
            ...
            public void onResponse(@NonNull Call<List<Post>> call, @NonNull Response<List<Post>> response) {
                if (response.isSuccessful() && response.body() != null && !response.body().isEmpty()) {
                    ...
                    Toast.makeText(MainActivity.this, getString(R.string.posts_loaded, count), Toast.LENGTH_LONG).show();
                } else {
    ...
    // --- Zadatak 8: Akcelerometar + Zadatak 4: Žiroskop ---
